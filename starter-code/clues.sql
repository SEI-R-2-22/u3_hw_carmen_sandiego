...
--Serravalle since it’s the only one with the same countrycode
...
--The city is called Serra and is located in Brazil
...
-- She's in Santa Monica located in California USA
